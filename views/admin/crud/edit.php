<!-- Template générique pour éditer un élément -->
<!-- Place ce fichier dans : views/admin/crud/edit.php -->
...
<div class="crud-edit-page p-6" data-table="<?= htmlspecialchars($table) ?>" data-id="<?= htmlspecialchars($id) ?>">
...
<style>
/* Styles identiques à create.php */
.styled-form {
    width: 100%;
}
